...
public class StudyOutputAdapterMongo implements StudyOutputPort {
	...
	public Study save(Study study) {
		...
		try {
			estudiosRepositoryMongo.save(estudiosMapperMongo.fromDomainToAdapter(study));
	...
	public List<Study> findByPerson(Integer personId) {
		log.debug("Into findByPerson on Adapter MongoDB");
	...
	public List<Study> findByProfession(Integer professionId) {
		log.debug("Into findByProfession on Adapter MongoDB");
